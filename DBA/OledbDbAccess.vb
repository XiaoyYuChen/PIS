...
#Region "字段"
    'Private Shared ReadOnly _Connstr = "Jet OLEDB:Database Password=" & Code.DecryptionAll("sICCcGDHXECIpIIGzIICnDFFGBDEKGEF") & ";Provider=Microsoft.Jet.OLEDB.4.0;Data Source=.\Data\us2006;Persist Security Info=False"
    Private Shared ReadOnly _Connstr = "Jet OLEDB:Database Password=123123;Provider=Microsoft.Jet.OLEDB.4.0;Data Source=.\App_Data\TransData.eee;Persist Security Info=False"
...
#Region "方法"
    ...
    ''' <remarks></remarks>
    Public Shared Function ExecNoQuery(ByVal cmdText As String, ByVal ParamArray params() As OleDbParameter) As Integer
        Dim cmd As New OleDbCommand
        Using conn As New OleDbConnection(ConnStr)
            PreparativeCommand(cmd, conn, Nothing, CommandType.Text, cmdText, params)
    ...
    ''' <returns>数据流</returns>
    ''' <remarks></remarks>
    Public Shared Function ExecuteReader(ByVal cmdText As String, ByVal ParamArray params() As OleDbParameter) As OleDbDataReader
        Dim cmd As New OleDbCommand
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ExecuteScalar(ByVal cmdText As String, ByVal ParamArray params() As OleDbParameter) As Object
        Dim cmd As New OleDbCommand
        Using conn As New OleDbConnection(ConnStr)
            PreparativeCommand(cmd, conn, Nothing, CommandType.Text, cmdText, params)
    ...
    ''' <remarks></remarks>
    Public Shared Function GetDataSet(ByVal cmdText As String, ByVal ParamArray params() As OleDbParameter) As DataSet
        Dim cmd As New OleDbCommand
    ...
    ''' <remarks></remarks>
    Public Shared Function GetDataTable(ByVal cmdText As String, ByVal ParamArray params() As OleDbParameter) As DataTable
        Dim cmd As New OleDbCommand
